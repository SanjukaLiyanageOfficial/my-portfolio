...
const newButton = `
          <a href="/Sachintha_Daham_CV.pdf" download="Sachintha_Daham_CV_2026.pdf" className="px-8 py-4 bg-transparent hover:bg-indigo-50 border-2 border-primary text-primary rounded-xl font-bold shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3">
            <Download size={20} />
            Download CV
          </a>`;
