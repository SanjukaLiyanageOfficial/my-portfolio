  ...
  return (
    ...
    >
      <div className="flex items-center gap-1">
        <div className="flex items-center gap-1.5"><span className="font-handwriting text-2xl text-primary font-bold">sanjuka</span><span className="font-comic text-2xl text-ink tracking-widest pt-1">LIYANAGE</span></div>
      </div>
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-500">
        ...
        <a href="https://github.com/SanjukaLiyanageOfficial" target="_blank" rel="noreferrer" className="hover:text-ink transition-colors flex items-center gap-1.5 hover:-translate-y-0.5 transform duration-200">
          GitHub 🐙
        </a>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="hidden md:flex items-center gap-3 text-slate-400">
          <a href="https://www.facebook.com/sanjuka.liyanage" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
            <SocialIcon path="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
          </a>
          <a href="https://www.instagram.com/sanjuka.liyanage" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
          ...
          <a href="https://linkedin.com/in/sanjuka-liyanage" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
          ...
          <a href="https://github.com/SanjukaLiyanageOfficial" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
            <SocialIcon path="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
          </a>
          <a href="https://wa.me/94705852167" target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
          ...
          <a href="mailto:liyanagesanju36@gmail.com" className="hover:text-primary transition-colors">
